            ...
            with open(fname,'w') as f:
                ...
                for v in self.variableList:
                    if v.isinstance(pr.RemoteVariable):
                        ...
                        f.write("{:#x}\t".format(v._block._size))
                        ...
                        f.write("{}\t".format(v.overlapEn))
                        f.write("{}\t".format(v.verify))
                        f.write("{}\t".format(v.bulkEn))
                        f.write("{}\t".format(v.updateNotify))
                        f.write("{}\t".format(v._base.modelId))
                        f.write("{}\t".format(v._base.isBigEndian))
                        f.write("{}\t".format(v._base.bitReverse))
                        f.write("{}\t".format(v._base.binPoint))
