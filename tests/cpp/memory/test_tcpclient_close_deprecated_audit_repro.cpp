 ...
 * ----------------------------------------------------------------------------
 * Description:
 * Regression test ensuring memory::TcpClient::close() carries a
 ...
 * comment (TcpClient.cpp line ~163) with no attribute on the declaration.
 *
...
TEST_CASE("memory::TcpClient::close() has [[deprecated]] attribute") {
