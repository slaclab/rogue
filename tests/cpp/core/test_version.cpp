 ...
 * ----------------------------------------------------------------------------
 * Description:
 * Native C++ tests for Rogue version helper behavior, including normalization
 * of the compiled version string, consistency between string and component
 * accessors, threshold helper semantics, and malformed-version rejection.
 * ----------------------------------------------------------------------------
