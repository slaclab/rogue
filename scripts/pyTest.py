...
# File writer 
dataFile = rogue.utilities.fileio.StreamWriter()

# Add data stream to file as tag 1, type 8
pyrogue.streamConnect(pgpVc1,dataFile.getPort(0x1,0x8))

## Add console stream to file as tag 2, type 10
pyrogue.streamConnect(pgpVc3,dataFile.getPort(0x2,0xA))
...
# Add Devices
version = pyrogue.devices.axi.AxiVersion(parent=root,memBase=srp)
