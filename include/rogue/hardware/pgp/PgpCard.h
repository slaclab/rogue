 ...
 */
class PgpCard : public rogue::interfaces::stream::Master, public rogue::interfaces::stream::Slave {
  ...
  public:
     ...
     */
    static std::shared_ptr<rogue::hardware::pgp::PgpCard> create(std::string path, uint32_t lane, uint32_t vc);
