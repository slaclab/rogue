...
rpx::XvcServer::XvcServer(uint16_t port, JtagDriver* drv, unsigned maxMsgSize) : drv_(drv), maxMsgSize_(maxMsgSize) {
    ...
    if (::listen(sd_, 1)) throw(rogue::GeneralError::create("XvcServer::XvcServer()", "Unable to listen on socket"));
}
