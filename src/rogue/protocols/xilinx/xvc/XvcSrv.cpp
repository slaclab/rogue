...
void
rpxx::JtagDriver::setDebug(unsigned debug)
{
	debug_ = debug;
}

void
rpxx::JtagDriver::setTestMode(unsigned flags)
{
	drEn_ = !!(flags & 1);
}
...
void
rpxx::JtagDriverAxisToJtag::setHdr(uint8_t *buf, Header   hdr)
{
...
void
rpxx::JtagDriverAxisToJtag::init()
{
...
void
rpxx::JtagDriverAxisToJtag::dumpInfo(FILE *f)
{
...
void
rpxx::JtagDriverAxisToJtag::usage()
{
}
...
void
rpxx::DriverRegistry::registerFactory(Factory f, Usage h)
{
