...
+------------------------------------------------+-----------------------+-------------+---------------+-----------------------------------------------------------------------------+
| :ref:`interfaces_memory_model_float16`         | 16-bit IEEE 754 float | float       | 16-bits       |                                                                             |
+------------------------------------------------+-----------------------+-------------+---------------+-----------------------------------------------------------------------------+
| :ref:`interfaces_memory_model_float16be`       | 16-bit IEEE 754 float | float       | 16-bits       | Big endian                                                                  |
+------------------------------------------------+-----------------------+-------------+---------------+-----------------------------------------------------------------------------+
...
+------------------------------------------------+-----------------------+-------------+---------------+-----------------------------------------------------------------------------+
| :ref:`interfaces_memory_model_float8`          | 8-bit E4M3 float      | float       | 8-bits        | NVIDIA FP8 (Hopper, Blackwell). No infinity.                                |
+------------------------------------------------+-----------------------+-------------+---------------+-----------------------------------------------------------------------------+
| :ref:`interfaces_memory_model_float8be`        | 8-bit E4M3 float      | float       | 8-bits        | Big endian                                                                  |
+------------------------------------------------+-----------------------+-------------+---------------+-----------------------------------------------------------------------------+
| :ref:`interfaces_memory_model_bfloat16`        | Brain Float 16        | float       | 16-bits       | 1s/8e/7m, float32 exponent range (~3.39e38). NVIDIA Ampere/Hopper/Blackwell |
+------------------------------------------------+-----------------------+-------------+---------------+-----------------------------------------------------------------------------+
| :ref:`interfaces_memory_model_bfloat16be`      | Brain Float 16        | float       | 16-bits       | Big-endian BFloat16                                                         |
+------------------------------------------------+-----------------------+-------------+---------------+-----------------------------------------------------------------------------+
| :ref:`interfaces_memory_model_tensorfloat32`   | NVIDIA TF32           | float       | 32-bits       | 1s/8e/10m, 19 bits in 4 bytes. NVIDIA Ampere/Hopper/Blackwell               |
+------------------------------------------------+-----------------------+-------------+---------------+-----------------------------------------------------------------------------+
| :ref:`interfaces_memory_model_tensorfloat32be` | NVIDIA TF32           | float       | 32-bits       | Big-endian TensorFloat32                                                    |
+------------------------------------------------+-----------------------+-------------+---------------+-----------------------------------------------------------------------------+
| :ref:`interfaces_memory_model_float6`          | 6-bit E3M2 float      | float       | 6-bits        | 1s/3e/2m, no NaN/Inf, max 28.0. NVIDIA Blackwell                            |
+------------------------------------------------+-----------------------+-------------+---------------+-----------------------------------------------------------------------------+
| :ref:`interfaces_memory_model_float6be`        | 6-bit E3M2 float      | float       | 6-bits        | Big-endian Float6                                                           |
+------------------------------------------------+-----------------------+-------------+---------------+-----------------------------------------------------------------------------+
| :ref:`interfaces_memory_model_float4`          | 4-bit E2M1 float      | float       | 4-bits        | 1s/2e/1m, no NaN/Inf, max 6.0. NVIDIA Blackwell                             |
+------------------------------------------------+-----------------------+-------------+---------------+-----------------------------------------------------------------------------+
| :ref:`interfaces_memory_model_float4be`        | 4-bit E2M1 float      | float       | 4-bits        | Big-endian Float4                                                           |
+------------------------------------------------+-----------------------+-------------+---------------+-----------------------------------------------------------------------------+
