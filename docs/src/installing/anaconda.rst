...
.. code::
   ...
   $ conda create -n rogue_tag -c defaults -c tidair-packages -c conda-forge -c tidair-tag -c pydm-tag rogue
...
.. code::
   ...
   $ conda install -c defaults -c tidair-packages -c conda-forge -c tidair-tag -c pydm-tag rogue
...
.. code::
   ...
   $ conda create -n rogue_dev -c defaults -c tidair-packages -c conda-forge -c tidair-dev -c pydm-tag rogue

Alternatively you can install a specific released version of Rogue:

.. code::

   $ conda create -n rogue_3.0.2 -c defaults -c tidair-packages -c conda-forge -c tidair-tag -c pydm-tag rogue=v3.0.2
