...
.. code::
   ...
   $ conda create -n rogue_tag -c defaults -c conda-forge -c paulscherrerinstitute -c tidair-tag rogue
...
.. code::
   ...
   $ conda create -n rogue_dev -c defaults -c conda-forge -c paulscherrerinstitute -c tidair-dev rogue

Alternatively you can install a specific released version of Rogue:

.. code::

   $ conda create -n rogue_3.0.2 -c defaults -c conda-forge -c paulscherrerinstitute -c tidair-tag rogue=v3.0.2
